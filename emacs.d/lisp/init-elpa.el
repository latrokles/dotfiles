...
;; this is lifted from Steve Purcell's emacs.d config after I couldn't get
;; Aaron Bieber's version of it to work.
;; added a couple more archives
;;; Code:
...
(let* ((no-ssl (and (memq system-type '(windows-nt ms-dos))
  ...
  (add-to-list 'package-archives (cons "org" (concat proto "://orgmode.org/packages/")) t)
