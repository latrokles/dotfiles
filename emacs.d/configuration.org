...
#+begin_src emacs-lisp
(setq worklog (expand-file-name "Desktop/worklog.org" (getenv "HOME")))
(setq devlog (expand-file-name "devlog.org" (getenv "WIKIDIR")))
#+end_src

Open log and start an entry.
#+begin_src emacs-lisp
(defun dwim-make-log-entry (logfile)
  (interactive)
  (find-file logfile)
...
#+begin_src emacs-lisp
(defun dwim-write-to-worklog ()
  (interactive)
  (dwim-make-log-entry worklog))
#+end_src

Open devlog and start an entry
#+begin_src emacs-lisp
(defun dwim-write-to-devlog ()
  (interactive)
  (dwim-make-log-entry devlog))
#+end_src

Quick facility to open ~~./emacs.d/configuration.org~ for editing.
#+begin_src emacs-lisp
(defun dwim-write-to-emacs-config ()
  (interactive)
...
(defun latrokles/configure-leader-keys ()
  ...
  (evil-leader/set-key
   ...
   "we"   'dwim-write-to-emacs-config
   "wd"   'dwim-write-to-devlog
   "ww"   'dwim-write-to-worklog
